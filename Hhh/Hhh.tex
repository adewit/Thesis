...
criteria and tight isolation requirements $I_{\text{rel}}^{\mu} < 0.1$
...
\end{center}
\caption[\mT~distributions in the \mutau and \etau channels.]{\mT~distributions in the \mutau (left) and \etau (right) channels.}
...
\end{center}
\caption[Number of b-tagged jets in the 2-jet selection of the \mutau and \etau channels.]{Number of b-tagged jets in the 2-jet selection of the \mutau (left) and \etau (right) channels. The signal
...
\end{center}
\caption[Reconstruced di-\Pgt invariant mass and di-jet invariant mass in
the 2jet-2tag category of the \mutau channel.]{Reconstructed di-\Pgt invariant mass (left) and di-jet invariant mass (right) in the 2jet-2tag category of the \mutau
...
applying Z--recoil corrections to DY, \Wjets and signal \ac{MC} events. Section \ref{sec:objects_met_recoilcorr} 
...
\end{center}
\caption[Comparison of the reconstructed heavy Higgs mass
using the kinematic fit in signal events with $m_{H}=300$ GeV and \ttbar 
background events in the 2jet-1tag category of the \mutau channel.]{Comparison of the reconstructed heavy Higgs mass using the kinematic fit (blue) and
...
$\sigma \times$ BR for the \AtoZhtolltautau process.]{The 95\% confidence level expected (dashed) and observed (solid)
...
\end{center}
\caption[Distributions of $m_{h}^{\text{kinfit}}$ in the 2jet-0tag,
2jet-1tag and 2jet-2tag categories of the \mutau channel.]{Distributions of $m_{H}^{\text{kinfit}}$ in the 2jet-0tag, 2jet-1tag and 2jet-2tag categories 
...
\end{center}
\caption[Distributions of $m_{H}^{\text{kinfit}}$ in the 2jet-0tag,
2jet-1tag and 2jet-2tag categories of the \etau channel.]{Distributions of $m_{H}^{\text{kinfit}}$ in the 2jet-0tag, 2jet-1tag and 2jet-2tag categories 
...
\caption[Expected and observed 95\% CL upper limits on cross--section
times branching ratio for the \Htohhtobbtautau process.]{Expected and observed 95\% CL upper limits on cross-section times branching ratio
...
interpreted in a type II 2HDM, assuming $m_{H} = m_{A} = m_{H^{+}} = 300$ GeV.]{Search for \Htohhtobbtautau (left) and \AtoZhtolltautau (right) interpreted in a type II 
...
\caption[Cross-section times branching ratio of the \Htohhtobbtautau
...
in the low \tanb~MSSM scenario have been overlaid.]{Cross-section times branching ratio of the \Htohhtobbtautau process (left) and of the
