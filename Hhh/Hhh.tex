...
\vec{p}_{\text{T,recoil}}^{\text{ meas}} = -\vec{p}_{\text{T,\PHiggs}}^{\text{ meas}} = -\vec{p}_{\text{T,miss}}^{\text{ meas}} - \vec{p}_{\text{T},\Pbottom 1}^{\text{ meas}} - \vec{p}_{\text{T},\Pbottom 2}^{\text{ meas}} - \vec{p}_{\text{T},\Pgt_1^{\text{vis}}}^{\text{ meas}} - \vec{p}_{\text{T},\Pgt_2^{\text{vis}}}^{\text{ meas}},
\end{equation}
and the recoil from the fit is,
~\vspace{-0.5\baselineskip}
\begin{equation}\label{eqn:kinfit_recoilfit}
\vec{p}_{\text{T,recoil}}^{\text{ fit}} = -\vec{p}_{\text{T,\PHiggs}}^{\text{ fit}} = - \vec{p}_{\text{T},\Pbottom 1}^{\text{ fit}} - \vec{p}_{\text{T},\Pbottom 2}^{\text{ fit}} - \vec{p}_{\text{T},\Pgt_1}^{\text{ fit}} - \vec{p}_{\text{T},\Pgt_2}^{\text{ fit}}.
\end{equation}
...
V_{\text{recoil}} = V_{\vec{p}_{\text{T,miss}}} - V_{\Pbottom {1}} - V_{\Pbottom 2},
\end{equation}
