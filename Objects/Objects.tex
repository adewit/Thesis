...
where $\mathcal{C}$ is a correction factor broken down into different
...
\subfloat[\MET resolution]{\includegraphics[width=0.5\texwidth]{./Objects/Plots/transverse_resolution_npv.png}}
\end{center}
...
\begin{figure}
\begin{center}
\subfloat[Isolation performance]{\includegraphics[width=0.5\textwidth]{./Plots/Objects/TauEfficiencyIsol.pdf}}\\
\subfloat[Anti-e discriminator efficiency]{\includegraphics[width=0.5\textwidth]{./Plots/Objects/TauEfficiencyEle.pdf}}
\subfloat[Anti-e discriminator fake rate]{\includegraphics[width=0.5\textwidth]{./Plots/Objects/TauMisIDEle.pdf}}
\end{center}
