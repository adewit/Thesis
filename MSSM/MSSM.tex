...
\begin{split}
\Delta(\text{NLL})_{68\%} = \text{NLL}(\text{best fit}) - \text{NLL}(\mu_{\Pg\Pg\phi}^{68\%},\mu_{\Pbottom\Pbottom\phi}^{68\%}) = 1.14, ~\\
\Delta(\text{NLL})_{95\%} = \text{NLL}(\text{best fit}) - \text{NLL}(\mu_{\Pg\Pg\phi}^{95\%},\mu_{\Pbottom\Pbottom\phi}^{95\%}) = 3.00.
\end{split}
\end{equation}
...
the $\pm 1\sigma$ and $\pm 2\sigma$ probability intervals on the expected exclusion in the \ac{SM} hypothesis.
...
The choice of correlation scheme is chosen
