...
for the $\Pg\Pg \rightarrow \phi$ and $\Pg\Pg \rightarrow \Pbottom\APbottom\phi$
...
only included in the \emu channel, are generated in part with \texttt{MadGraph 5} and in
...
\mutau channel, with the signal normalised to 4000 times its \xsbr 
 at \mA~$=1\,\TeV$ and \tanb~$=50$ in the $m_{\PHiggslight}^{\text{mod}+}$ scenario overlaid.
...
The pre-fit expected upper limits on \xsbr for both $\Pgluon\Pgluon\phi$ and $\Pbottom\Pbottom\phi$
...
tau isolation working point selection on both the \Pgluon\Pgluon$\phi$ and \Pbottom\Pbottom$\phi$ production processes. 
...
two jets are misreconstructed as the two tau candidates. %Relatively likely to happen in tautau channel
...
and after the maximum likelihood fit to the QCD signal strength.]{The visible mass distribution of the di-tau pair in the \mutau channel for the sideband near the signal region, (a) before
...
before and after the maximum likelihood fit to the QCD signal strength.]{The visible mass distribution of the di-tau pair in the \mutau channel for the sideband further away from the signal region, (a) before
...
before and after the maximum likelihood fit to the QCD signal strength.]{The visible mass distribution of the di-tau pair in the \etau channel for the sideband near the signal region, (a) before
the maximum likelihood fit to the QCD signal strength and (b) after the fit. The resulting fitted signal strength is $1.015\pm0.059$.}
...
strength.]{The visible mass distribution of the di-tau pair in the \etau channel for the sideband further away from the signal region, (a) before
the maximum likelihood fit to the QCD signal strenght and (b) after the fit. The resulting fitted signal strength
is $1.127\pm0.045$.}
...
and \tanb~$=50$ in the $m_{\PHiggslight}^{mod+}$ scenario is overlaid \cite{CMS-PAS-HIG-16-037}.}% Note that, to incorporate
...
\begin{figure}[h!]
\begin{center}
\subfloat[$m_{\PHiggslight}^{\text{mod}+}$ scenario]{\includegraphics[width=0.65\textwidth]{./MSSM/Figures/CMS-PAS-HIG-16-037_Figure_012-a.pdf}}~\\
...
\end{center}
\caption[Transverse component of the di-tau mass for expected backgrounds
and observed events in the no b-tag and b-tag categories of the \etau channel.]{Transverse component of the di-tau mass for expected backgrounds and
...
channel.]{Transverse component of the di-tau mass for expected backgrounds and
