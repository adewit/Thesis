...
%b \end{pmatrix}.
%\end{equation}
The SU(2)$_{\text{L}}$ part of the symmetry is built from the weak
isospin generators \mbox{$I_{1,2,3} = \frac{1}{2}\sigma_{1,2,3}$},
where $\sigma_i$ are the Pauli spin matrices. The U(1)$_{\text{Y}}$
...
\begin{figure}[h!]
\begin{center}
\subfloat[$\sigma(\Pg\Pg\rightarrow \PHiggs)$ (pb)]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/xs_ggH_mhmodp.pdf}}
\subfloat[$\sigma(\Pg\Pg\rightarrow \Pbottom\Pbottom\PHiggs)$ (pb)]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/xsbbH4F_mhmodp.pdf}}
\end{center}
