...
The weak interaction, working on all fermions,
...
Under a local $SU(2)\times U(1)$ transformation, with hypercharge Y=$\frac{1}{2}$
...
Looking at fluctuations around the vacuum state,
