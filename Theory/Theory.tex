...
%&\phi^{+*}\phi^+ + \phi^{0*}\phi^0 = \frac{\mu^2}{2\lambda} \text{ and choosing } \phi^+ \text{ = 0 and } \phi^0 \text{ to be real,}\\
...
\tanb~up to around \tanb=3, when the cross sections start increasing with increasing \tanb~again.
