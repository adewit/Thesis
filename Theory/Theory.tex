...
\begin{figure}[h!]
\begin{center}
\subfloat[\ac{SM} \PHiggs production cross sections]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/plot_13tev_H_sqrt.pdf}}
\subfloat[\ac{SM} \PHiggs branching ratios]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/SMHiggsBRYR4-square.pdf}}
\end{center}
...
\end{center}
\caption[Summary of the interpretations of Run 1 BSM Higgs searches at CMS in the $m_{\PHiggslight}^{\text{mod+}} scenario and the hMSSM scenario.]{Summary of the interpretations of Run 1 \ac{BSM} Higgs searches at \acs{CMS} in (a) the $m_{\PHiggslight}^{\text{mod+}}$ and (b) the
