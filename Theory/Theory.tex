...
The associated gauge fields are the three weak isospin fields $W_{\mu}^{i}$ and the
...
and UA2 collaborations at \acs{CERN}a, confirming the predicitions from electroweak unification.
...
\begin{split}
&\mathcal{L}_{\text{Higgs}} = -\frac{1}{2}\partial_{\mu}h\partial^{\mu}h -\frac{g^2v^2}{4}\PW_{\mu}^- \PW^{\mu +} - \frac{g^2+g'^2}{8}v^2\PZ_{\mu}\PZ^{\mu}  - \mu_{\text{SM}}^2h^2  + \\ 
...
shows very good agreement with the \ac{SM} predictions \cite{CouplComb}. In addition, 
the $\PHiggslight \rightarrow \Pgt\Pgt$ decay was observed with a significance of 5.5$\sigma$ through this combination, while
...
\end{center}
\caption[Tree-level Feynman diagrams for the dominant Higgs production modes at the LHC]{Tree-level Feynman diagrams for the dominant Higgs boson production modes at
the \ac{LHC}.}
...
\begin{figure}[h!]
\begin{center}
\subfloat[\ac{SM} H production cross sections]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/plot_13tev_H_sqrt.pdf}}
\subfloat[\ac{SM} H branching ratios]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/SMHiggsBRYR4-square.pdf}}
\end{center}
...
The masses of the neutral scalars \PHiggs and \PHiggslight are the eigenvalues of 
...
%m_{\PHiggs,\PHiggslight}^2 = \frac{1}{2}(m_{A}^2+m_{Z}^2 \pm \sqrt{(m_A^2+m_Z^2)^2-4m_Z^2m_A^2\cos{2\beta}^2}).
%\end{equation}
A consequence of equation \ref{eqn:scalarmass} is a tree-level upper bound to the mass of the light Higgs
boson,
...
at (a) \tanb=5~and (b) \tanb=30. The branching ratio into $\tau\tau$ (blue), $b\bar{b}$ (red) 
...
\begin{figure}[h!]
\begin{center}
\subfloat[gluon fusion production]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/CMS-PAS-HIG-16-037_Figure_001-a.png}}
...
\begin{figure}[h!]
\begin{center}
\subfloat[\PHiggs]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/typeII2HDMxsbr.png}}
\subfloat[\PHiggsps]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/typeII2HDMxsbrA.png}}
\end{center}
...
\subfloat[$\sigma(gg\rightarrow bb\PHiggs)$]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/xsbbH4F_mhmodp.pdf}}
\end{center}
\caption[Production cross--sections of  gluon fusion and b--associated
production of the \PHiggs boson in the $m_{h}^{\text{mod+}}$ scenario.]{Production cross--section of (a) gluon fusion production and (b) b--associated production of the \PHiggs boson
...
\begin{figure}[h!]
\begin{center}
\subfloat[$m_{h}^{\text{mod}+}$ scenario]{\includegraphics[width=0.5\textwidth]{./Theory/Figures/mh_mhmodp.pdf}}
...
\tanb~in the $m_{h}^{\text{mod+}}$ scenario and the low \tanb~scenario.]{The mass of the light Higgs boson, \mh, as a function 
...
The branching ratios of \PHiggs and \PHiggsps into $\tau\tau$ follow a similar
...
In Run 2 of the \acs{LHC} searches for \AHtotautau, setting more stringent limits than those shown in figure \ref{fig:bsm_summary},
...
\end{center}
\caption[Summary of the interpretations of Run 1 BSM Higgs searches at CMS in the $m_{h}^{\text{mod+}} scenario and the hMSSM scenario.]{Summary of the interpretations of Run 1 \ac{BSM} Higgs searches at \acs{CMS} in (a) the $m_{h}^{\text{mod+}}$ and (b) the
