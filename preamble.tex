...
\DeclareRobustCommand{\ggHtohhtobbtautau}{\HepProcess{ \Pgluon \Pgluon \to \PHiggs \to \PHiggslight \PHiggslight \to \Pbottom \Pbottom \Pgt \Pgt}\xspace}
\DeclareRobustCommand{\htotautau}{\HepProcess{ \PHiggslight \to \Pgt \Pgt}\xspace}
\DeclareRobustCommand{\Htotautau}{\HepProcess{ \PHiggs \to \Pgt \Pgt}\xspace}
...
\newcommand{\tautau}{$\Pgth\Pgth$\xspace}
\newcommand{\xsbr}{$\sigma{\times}\mathcal{B}$\xspace}
\DeclareRobustCommand{\mumu}{\HepProcess{\Pmu\Pmu} \xspace}
