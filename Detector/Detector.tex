...
\begin{figure}[h!]
\includegraphics[width=0.6\textwidth]{./Detector/Plots/LHC_default.jpg}
\caption{Schematic of the \ac{CERN} accelerator complex \cite{lhc-schematic}.}
\label{fig:lhc_schematic}
\end{figure}
The \ac{LHC} does not operate on its own: the protons are lead into
...
this year 4.2 fb$^{-1}$ was delivered to \ac{CMS}. The \ac{LHC} operated at a centre-of-mass energy of 13 TeV 
...
per bunch crossing increased to 24 \cite{CMS-PAS-HIG-16-037}. Additional 
...
The silicon tracker, a cylinder 5.8 m in length and 2.6 m in
...
solenoid, 13 m long, 6 m in diameter and operating at 3.8 Tesla.
...
The pixel tracker will be upgraded during the extended year-end technical stop in early 2017. This upgrade is needed to
...
starts to dominate for electrons. The shower ionises the atoms in the lead-tungstate
...
has a thickness of between 5.82 and 10.6 interaction length, which is not 
...
muons appear in the final states of many \ac{BSM} signatures the experiment is used to search for.
